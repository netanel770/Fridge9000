...
export default function InventoryScreen() {
  ...
  return <View style={styles.screen}>
    <FlatList data={visibleItems} keyExtractor={(item) => String(item.id)} refreshControl={<RefreshControl refreshing={refreshing} onRefresh={() => loadData(true)} />} contentContainerStyle={styles.list}
...
const styles = StyleSheet.create({
  ...
  filters: { flexDirection: "row", gap: spacing.sm }, filter: { paddingHorizontal: spacing.md, paddingVertical: 8, borderRadius: radius.pill, backgroundColor: colors.surface, borderWidth: 1, borderColor: colors.border }, activeFilter: { backgroundColor: colors.primary, borderColor: colors.primary }, filterText: { color: colors.textSecondary, fontWeight: "700", fontSize: 12 }, activeFilterText: { color: colors.primaryText },
  card: { backgroundColor: colors.surface, borderRadius: radius.xl, borderWidth: 1, borderColor: colors.border, padding: spacing.lg, shadowColor: colors.navy, shadowOpacity: 0.04, shadowRadius: 8, shadowOffset: { width: 0, height: 3 }, elevation: 1 }, cardTop: { flexDirection: "row", alignItems: "center", gap: spacing.md }, productIcon: { width: 48, height: 48, borderRadius: 15, backgroundColor: colors.primarySoft, alignItems: "center", justifyContent: "center" }, cardCopy: { flex: 1 }, name: { fontSize: 18, fontWeight: "800", color: colors.navy }, category: { color: colors.textMuted, fontSize: 13, marginTop: 2 },
  metrics: { flexDirection: "row", marginTop: spacing.lg, borderRadius: radius.lg, backgroundColor: colors.surfaceMuted, padding: spacing.md }, metric: { flex: 1, alignItems: "center" }, metricValue: { color: colors.navy, fontWeight: "800", fontSize: 17 }, metricLabel: { color: colors.textMuted, fontSize: 11, marginTop: 2 }, expiryRow: { flexDirection: "row", alignItems: "center", gap: spacing.sm, marginTop: spacing.md }, expiry: { flex: 1, color: colors.textSecondary, fontSize: 13 },
