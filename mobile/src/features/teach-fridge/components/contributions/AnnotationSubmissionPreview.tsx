...
export function AnnotationSubmissionPreview({ detail, focusedAnnotationId, onFocusAnnotation }: {
  ...
  return <View style={styles.annotationSubmissionPreview}>
    <DetectionImageViewer imageUri={getScanImageUrl(detail.submission.scan_id)} imageWidth={imageWidth} imageHeight={imageHeight} detections={drawableDetections} highlightedDetectionId={focusedAnnotationId} showLabels={false} style={[styles.quarantineImage, { aspectRatio: imageWidth / imageHeight }]} />
