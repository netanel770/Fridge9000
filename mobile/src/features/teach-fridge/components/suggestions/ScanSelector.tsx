...
import { formatIsraelDate } from "../../../../utils/date";
      ...
      {scans.map((scan) => {
        ...
        return (
          <Pressable
            ...
            style={[
              styles.scanChip,
              selected && styles.selectedScanChip,
            ]}
          >
            <Text
              style={[
                styles.scanChipTitle,
                selected && styles.selectedScanText,
              ]}
            >
              Scan #{scan.id}
            </Text>
            ...
            >
              {formatIsraelDate(scan.created_at)}
            </Text>
            <Text
              style={[
                styles.scanChipMeta,
            ...
            >
              {scan.detection_count} detection
              {Number(scan.detection_count) === 1 ? "" : "s"}
            </Text>
          </Pressable>
        );
      })}
